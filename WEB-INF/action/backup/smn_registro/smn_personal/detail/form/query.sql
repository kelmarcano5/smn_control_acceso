select
	...
	smn_control_acceso.smn_turnos.tur_nombre as psl_grupo,
	smn_control_acceso.smn_personal.psl_grupo_fecha_inicio
from
	...
	left outer join smn_base.smn_v_auxiliar on smn_base.smn_v_auxiliar.smn_v_auxiliar_id = smn_control_acceso.smn_personal.psl_auxiliar
	...
	left outer join smn_base.smn_clase_auxiliar on smn_base.smn_clase_auxiliar.smn_clase_auxiliar_id = smn_control_acceso.smn_personal.psl_clase_auxiliar
	...
	left outer join smn_gip.smn_esquema_rotacion on smn_gip.smn_esquema_rotacion.ero_turno = smn_control_acceso.smn_personal.psl_grupo
	inner join smn_control_acceso.smn_turnos on smn_control_acceso.smn_turnos.smn_turnos_id = smn_gip.smn_esquema_rotacion.ero_turno
where
