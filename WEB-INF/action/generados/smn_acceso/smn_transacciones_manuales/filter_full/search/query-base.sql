select	
	...
	smn_control_acceso.smn_transacciones_manuales.trm_dispositivo,
	smn_control_acceso.smn_transacciones_manuales.trm_identificacion,
	smn_control_acceso.smn_transacciones_manuales.trm_marcaje,
...
where
	smn_transacciones_manuales_id is not null	
 	 	${filter}
order by 
