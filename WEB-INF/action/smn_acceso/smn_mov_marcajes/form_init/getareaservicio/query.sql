...
where smn_base.smn_areas_servicios.ase_sucursal=(SELECT smn_base.smn_sucursales.smn_sucursales_id
...
group by id order by smn_base.smn_areas_servicios.ase_codigo desc