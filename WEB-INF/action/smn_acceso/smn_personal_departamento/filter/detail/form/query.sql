select
	...
	smn_gip.smn_esquema_rotacion.ero_codigo ||' - '|| smn_gip.smn_esquema_rotacion.ero_nombre as tur_nombre,
	...
	smn_gip.smn_dispositivos.dis_codigo||'-'||smn_gip.smn_dispositivos.dis_serial as smn_dispositivos_rf,
	case
	...
	smn_gip.smn_clasificacion_horaria.cho_codigo ||' - '|| smn_gip.smn_clasificacion_horaria.cho_descripcion as smn_clasificacion_horaria_rf
...
from
	...
	INNER JOIN smn_gip.smn_dispositivos on smn_gip.smn_dispositivos.smn_dispositivos_id = smn_control_acceso.smn_personal.smn_dispositivos_rf
	left outer join smn_gip.smn_clasificacion_horaria on smn_gip.smn_clasificacion_horaria.smn_clasificacion_horaria_id = smn_control_acceso.smn_personal.smn_clasificacion_horaria_rf
where
