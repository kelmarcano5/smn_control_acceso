select
	(select smn_gip.smn_esquema_rotacion.ero_codigo || ' - ' || smn_gip.smn_esquema_rotacion.ero_nombre from  smn_gip.smn_esquema_rotacion  where smn_gip.smn_esquema_rotacion.smn_esquema_rotacion_id is not null  and smn_gip.smn_esquema_rotacion.smn_esquema_rotacion_id=smn_control_acceso.smn_personal.psl_esquema_rotacion_rf  order by smn_gip.smn_esquema_rotacion.ero_nombre ) as smn_esquema_rotacion_rf_combo,
	...
	(select smn_gip.smn_cargos.job_codigo|| ' - ' || smn_gip.smn_cargos.job_nombre from  smn_gip.smn_cargos  where smn_gip.smn_cargos.smn_cargos_id is not null  and smn_gip.smn_cargos.smn_cargos_id=smn_control_acceso.smn_personal.psl_cargo_rf  order by smn_gip.smn_cargos.job_nombre ) as psl_cargos_rf_combo,
