...
from
        ...
        inner join smn_base.smn_areas_servicios on  smn_base.smn_areas_servicios.smn_areas_servicios_id = smn_control_acceso.smn_personal.psl_area_servicio_rf
...
where smn_control_acceso.smn_personal.psl_esquema_rotacion_rf = ${fld:id3} and smn_base.smn_estructura_organizacional.eor_nombre = ${fld:id2} and
