...
where
	smn_control_acceso.smn_plan_asistencia.smn_plan_asistencia_id is not null and smn_control_acceso.smn_plan_asistencia.cpa_usuario='${def:user}'
	${filter}
ORDER BY
		smn_control_acceso.smn_plan_asistencia.smn_plan_asistencia_id desc
