select
	...
	smn_gip.smn_dispositivos.dis_descripcion as trn_dispositivo_combo,
...
from
	...
	inner join smn_gip.smn_dispositivos on smn_gip.smn_dispositivos.smn_dispositivos_id = cast(smn_control_acceso.smn_transacciones.trn_dispositivo as INTEGER)	
