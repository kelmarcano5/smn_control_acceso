...
where 
	smn_control_acceso.smn_visitantes.smn_numero_carnet_asignado_id is null and smn_control_acceso.smn_visitantes.vis_hora_entrada is null and
smn_control_acceso.smn_visitantes.vis_estatus='RE' and smn_control_acceso.smn_visitantes.vis_fecha_vigencia=CURRENT_DATE