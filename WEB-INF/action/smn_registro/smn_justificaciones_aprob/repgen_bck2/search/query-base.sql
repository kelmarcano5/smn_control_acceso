...
${field},
	...
	smn_gip.smn_tipo_actividades.tya_nombre as jus_tipo_actividad_rf,
...
from
	...
	left outer join smn_seguridad.s_user on smn_seguridad.s_user.userlogin = smn_control_acceso.smn_justificaciones.jus_usuario
where
 smn_control_acceso.smn_justificaciones.jus_estatus_rf='PEN' and smn_control_acceso.smn_justificaciones.jus_usuario='${def:user}'
 ${filter}

order by
	 smn_control_acceso.smn_justificaciones.jus_estatus_rf  desc
