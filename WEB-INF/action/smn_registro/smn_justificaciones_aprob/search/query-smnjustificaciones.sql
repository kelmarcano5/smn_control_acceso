...
where
	smn_control_acceso.smn_justificaciones.jus_estatus_rf IN ('PEN', 'GE') and smn_control_acceso.smn_justificaciones.jus_usuario<>'${def:user}'
  	and smn_control_acceso.smn_justificaciones.jus_jefe_inmediato_rf=(select smn_base.smn_usuarios.smn_auxiliar_rf from smn_base.smn_auxiliar
