select	
	...
	smn_control_acceso.smn_personal.psl_id_control_acceso as psl_id_control_acceso_pl0,
...
where
	smn_solicitud_permisos_id is not null
and 	smn_control_acceso.smn_personal.smn_personal_id=smn_control_acceso.smn_solicitud_permisos.smn_personal_id 
