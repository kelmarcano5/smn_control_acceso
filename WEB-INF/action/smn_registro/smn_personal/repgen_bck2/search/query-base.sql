select
    ${field},
	smn_base.smn_areas_servicios.ase_descripcion as psl_area_servicio_rf,
	smn_base.smn_auxiliar.aux_codigo||'-'|| smn_base.smn_auxiliar.aux_descripcion as smn_auxiliar,
	smn_gip.smn_categoria_cargos.cac_nombre as psl_categoria_cargo_rf,
	smn_gip.smn_cargos.job_nombre ||'-'|| smn_gip.smn_cargos.job_codigo as psl_cargo_rf,
	smn_base.smn_centro_costo.cco_descripcion_corta as psl_centro_costo_rf,
	smn_base.smn_clase_auxiliar.cla_nombre as psl_clase_auxiliar_rf,
	smn_base.smn_entidades.ent_descripcion_corta as psl_empresa_rf,
	smn_base.smn_estructura_organizacional.eor_nombre as psl_estructura_organizacional_rf,
	smn_base.smn_sucursales.suc_nombre as psl_sucursal_rf,
	smn_base.smn_unidades_servicios.uns_descripcion as psl_unidad_servicio_rf,
	...
	smn_base.smn_auxiliar.aux_codigo||'-'|| smn_base.smn_auxiliar.aux_descripcion as psl_auxiliar_rf,--smn_item,
	...
	smn_gip.smn_categoria_personal.cap_codigo ||'-'|| smn_gip.smn_categoria_personal.cap_nombre as psl_categoria_personal_rf		
...
where
	...
	${filter}
--where
--	smn_gip.smn_esquema_rotacion.smn_esquema_rotacion_id=smn_control_acceso.smn_personal.psl_esquema_rotacion_rf
order by
