...
from
	...
	left join smn_base.smn_sucursales on smn_base.smn_sucursales.smn_sucursales_id = smn_control_acceso.smn_personal_visitantes.smn_sucursal_rf
	...
	left join smn_base.smn_auxiliar aut on aut.smn_auxiliar_id = smn_control_acceso.smn_personal_visitantes.rpv_autorizador

where 
	smn_control_acceso.smn_personal_visitantes.rpv_usuario='${def:user}' and smn_control_acceso.smn_personal_visitantes.rpv_fecha_evento=CURRENT_DATE