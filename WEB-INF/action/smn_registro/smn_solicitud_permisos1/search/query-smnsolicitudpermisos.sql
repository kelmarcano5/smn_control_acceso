select DISTINCT
	...
	smn_control_acceso.smn_solicitud_permisos.smn_personal_id as smn_personal_id2,
	...
	smn_control_acceso.smn_solicitud_permisos.spe_fecha_registro,
		case
		when smn_gip.smn_documentos.dcm_tipo = 'PE' then 4
	end as spe_documento_rf2
from
	...
	inner join smn_seguridad.s_user on smn_seguridad.s_user.userlogin = smn_control_acceso.smn_solicitud_permisos.spe_usuario
where 
	 smn_control_acceso.smn_solicitud_permisos.spe_estatus_rf='PEN' and
	smn_control_acceso.smn_solicitud_permisos.spe_usuario='${def:user}'
order by smn_control_acceso.smn_solicitud_permisos.spe_fecha_registro asc
