...
where 
smn_seguridad.s_user.userlogin<>'${def:user}' and smn_control_acceso.smn_solicitud_permisos.spe_jefe_inmediato_rf=(select smn_base.smn_usuarios.smn_auxiliar_rf from smn_base.smn_auxiliar
