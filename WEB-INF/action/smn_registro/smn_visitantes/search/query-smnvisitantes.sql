...
where
	smn_control_acceso.smn_visitantes.vis_estatus in ('RE') AND 
	smn_control_acceso.smn_visitantes.vis_usuario='${def:user}'
ORDER BY smn_control_acceso.smn_visitantes.vis_fecha_registro DESC