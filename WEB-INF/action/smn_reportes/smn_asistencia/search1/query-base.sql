...
select DISTINCT rows.asi_personal_rf, rows.smn_empresa_rf, rows.smn_sucursal_rf, 
...
left outer JOIN smn_control_acceso.smn_solicitud_permisos ON smn_control_acceso.smn_solicitud_permisos.smn_personal_id = rows.personal_id
where smn_control_acceso.smn_solicitud_permisos.spe_fecha_hasta>=${fld:asi_fecha_registro_fin}
