select
	...
	smn_base.smn_centro_costo.cco_codigo || '-' || smn_base.smn_centro_costo.cco_descripcion_corta as centro_costo_combo,
	case
		when smn_control_acceso.smn_asistencia.asi_estatus_entrada='AS' then 'Asistio'
		when smn_control_acceso.smn_asistencia.asi_estatus_asistencia_rf='NA' then 'No Asistio'
...
from
	...
	inner join smn_base.smn_centro_costo on smn_base.smn_centro_costo.smn_centro_costo_id = smn_control_acceso.smn_personal.psl_centro_costo_rf
where
	...
	--AND smn_control_acceso.smn_asistencia.asi_estatus_entrada is null 