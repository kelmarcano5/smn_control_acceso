with rows as (
	...
	smn_base.smn_auxiliar.aux_nombres ||' '|| smn_base.smn_auxiliar.aux_apellidos as nombre,
		...
		smn_gip.smn_dispositivos.dis_tipo_dispositivo_rf as tipo,
...
where
	smn_control_acceso.smn_mov_marcajes.smn_mov_marcajes_id is not null and smn_control_acceso.smn_mov_marcajes.mrk_marcaje_hora<='09:00'
	${filter}
