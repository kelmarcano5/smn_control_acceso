...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("dis_empresa_name");
			if (d != null)
			{
			name  = "b_entity";
			label = "${lbl:b_entity}";
		...
		d = rs.getString("dis_area_servicio_name");
			if (d != null)
			{
			name  = "b_service_area";
		...
		d = rs.getString("dis_sucursal_name");
			if (d != null)
			{
			name  = "b_subsidiary";
			label = "${lbl:b_subsidiary}";
		...
		d = rs.getString("dis_area_servicio");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
