package domain.repgen.smn_acceso.smn_mov_marcajes;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("mrk_documento_rf_name");
			if (d != null)
			{
			name  = "b_documento";
			label = "${lbl:b_documento}";
		...
		d = rs.getString("mrk_area_servicio_rf_name");
			if (d != null)
			{
			name  = "b_service_area";
		...
		d = rs.getString("mrk_sucursal_rf_name");
			if (d != null)
			{
			name  = "b_subsidiary";
		...
		d = rs.getString("mrk_unidad_servicio_rf_name");
			if (d != null)
			{
			name  = "b_service_unit";
		...
		d = rs.getString("mrk_empresa_rf_name");
			if (d != null)
			{
			name  = "b_entity";
			label = "${lbl:b_entity}";
		...
		d = rs.getString("mrk_centro_costo_rf_name");
			if (d != null)
			{
			name  = "b_cost_centers";
		...
		d = rs.getString("mrk_centro_costo_rf");
			if (d != null)
			{
			name  = "b_cost_centers";
			label = "${lbl:b_cost_centers}";
		...
		d = rs.getString("mrk_sucursal_rf");
			if (d != null)
			{
			name  = "b_subsidiary";
			label = "${lbl:b_subsidiary}";
		...
		d = rs.getString("mrk_documento_rf");
			if (d != null)
			{
			name  = "b_documento";
			label = "${lbl:b_documento}";
		...
		d = rs.getString("mrk_unidad_servicio_rf");
			if (d != null)
			{
			name  = "b_service_unit";
			label = "${lbl:b_service_unit}";
		...
		d = rs.getString("mrk_area_servicio_rf");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
