...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("trn_fecha_transaccion_fin");
			if (d != null)
			{
		...
		d = rs.getString("trn_hora_transaccion_fin");
			if (d != null)
			{
		...
		d = rs.getString("trn_fecha_transaccion_ini");
			if (d != null)
			{
		...
		d = rs.getString("trn_hora_transaccion_ini");
			if (d != null)
			{
		...
		d = rs.getString("trn_identificacion");
			if (d != null)
			{
			name  = "b_indentification";
			label = "${lbl:b_indentification}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
