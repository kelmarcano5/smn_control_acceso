package domain.repgen.smn_acceso.smn_transacciones_desnorm;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("trd_identificacion");
			if (d != null)
			{
		...
		d = rs.getString("trd_fecha_transaccion_fin");
			if (d != null)
			{
		...
		d = rs.getString("trd_fecha_transaccion_ini");
			if (d != null)
			{
