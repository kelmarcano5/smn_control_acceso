...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("trm_hora_transaccion_ini");
			if (d != null)
			{
		...
		d = rs.getString("trm_fecha_transaccion_fin");
			if (d != null)
			{
		...
		d = rs.getString("trm_fecha_transaccion_ini");
			if (d != null)
			{
		...
		d = rs.getString("trm_hora_transaccion_fin");
			if (d != null)
			{
		...
		d = rs.getString("trm_identificacion");
			if (d != null)
			{
