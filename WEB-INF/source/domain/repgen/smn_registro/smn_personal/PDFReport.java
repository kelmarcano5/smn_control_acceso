...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("psl_estructura_organiz");
			if (d != null)
			{
			name  = "b_organizational_structure";
			label = "${lbl:b_organizational_structure}";
		...
		d = rs.getString("psl_auxiliar_name");
			if (d != null)
			{
			name  = "b_auxiliary";
			label = "${lbl:b_auxiliary}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("psl_cargo_name");
			if (d != null)
			{
			name  = "b_positions";
			label = "${lbl:b_positions}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("psl_sucursal");
			if (d != null)
			{
			name  = "b_subsidiary";
			label = "${lbl:b_subsidiary}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("psl_sucursal_name");
			if (d != null)
			{
			name  = "b_subsidiary";
			label = "${lbl:b_subsidiary}";
		...
		d = rs.getString("psl_centro_costo");
			if (d != null)
			{
			name  = "b_cost_centers";
			label = "${lbl:b_cost_centers}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("psl_unidad_servicio_name");
			if (d != null)
			{
			name  = "b_service_unit";
			label = "${lbl:b_service_unit}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("psl_area_servicio");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("psl_area_servicio_name");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
		...
		d = rs.getString("psl_empresa_name");
			if (d != null)
			{
			name  = "b_entity";
			label = "${lbl:b_entity}";
		...
		d = rs.getString("psl_unidad_servicio");
			if (d != null)
			{
			name  = "b_service_unit";
			label = "${lbl:b_service_unit}";
		...
		d = rs.getString("psl_centro_costo_name");
			if (d != null)
			{
			name  = "b_cost_centers";
			label = "${lbl:b_cost_centers}";
		...
		d = rs.getString("psl_estructura_organiz_name");
			if (d != null)
			{
			name  = "b_organizational_structure";
			label = "${lbl:b_organizational_structure}";
		...
		d = rs.getString("psl_id_control_acceso");
			if (d != null)
			{
			name  = "b_id_access_control";
			label = "${lbl:b_id_access_control}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
