package domain.repgen.smn_registro.smn_rol;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_entidad_rf_name");
			if (d != null)
			{
			name  = "b_entities";
		...
		d = rs.getString("smn_unidad_servicio_rf_name");
			if (d != null)
			{
			name  = "b_units_service";
			label = "${lbl:b_units_service}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_sucursal_rf_name");
			if (d != null)
			{
			name  = "b_subsidiaries";
		...
		d = rs.getString("smn_estructura_organizacional_rf");
			if (d != null)
			{
		...
		d = rs.getString("smn_sucursal_rf");
			if (d != null)
			{
			name  = "b_subsidiaries";
			label = "${lbl:b_subsidiaries}";
		...
		d = rs.getString("smn_corporacion_rf");
			if (d != null)
			{
			name  = "b_corporation";
			label = "${lbl:b_corporation}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_estructura_organizacional_rf_name");
			if (d != null)
			{
			name  = "b_organizational_structure";
			label = "${lbl:b_organizational_structure}";
		...
		d = rs.getString("smn_area_servicio_rf");
			if (d != null)
			{
			name  = "b_area_service";
			label = "${lbl:b_area_service}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_unidad_servicio_rf");
			if (d != null)
			{
			name  = "b_units_service";
			label = "${lbl:b_units_service}";
		...
		d = rs.getString("smn_area_servicio_rf_name");
			if (d != null)
			{
			name  = "b_area_service";
			label = "${lbl:b_area_service}";
		...
		d = rs.getString("smn_corporacion_rf_name");
			if (d != null)
			{
			name  = "b_corporation";
			label = "${lbl:b_corporation}";
		...
		d = rs.getString("smn_usuario_id_name");
			if (d != null)
			{
			name  = "b_users";
			label = "${lbl:b_users}";
