...
//////////////////////////////////////////////
	...
	///////////////////////////////////////////////////
	public void generarAsitencia(String idPlanAsistencia,int esquemaId, int estructuraId,ArrayList<horarios> dias,String fechDesde,String fechHasta, String usuario) throws Throwable {
...
//                		" and smn_control_acceso.smn_personal.psl_esquema_rotacion_rf="+esquemaId+" "+ 
						...
						sentenciaValidarP="select smn_control_acceso.smn_personal.smn_personal_id, "
								+"p.cpa_fecha_desde_cal, "
								+"p.cpa_fecha_hasta_cal "
								+"from smn_control_acceso.smn_plan_asistencia_personal "
								+"inner join smn_control_acceso.smn_personal on smn_control_acceso.smn_personal.smn_personal_id=smn_control_acceso.smn_plan_asistencia_personal.smn_personal_id "
								+"inner join smn_base.smn_entidades on smn_base.smn_entidades.smn_entidades_id = smn_control_acceso.smn_personal.psl_empresa_rf "
								+"inner join smn_base.smn_estructura_organizacional on smn_base.smn_estructura_organizacional.smn_estructura_organizacional_id = smn_control_acceso.smn_personal.psl_estructura_organizacional_rf  "
								...
								+"inner join smn_control_acceso.smn_plan_asistencia p on p.smn_plan_asistencia_id=smn_control_acceso.smn_plan_asistencia_personal.smn_plan_asistencia_id "
								+"where smn_control_acceso.smn_plan_asistencia_personal.smn_plan_asistencia_id = " +idPlanAsistencia
								+" and smn_control_acceso.smn_asistencia.asi_fecha_evento >= p.cpa_fecha_desde_cal "
								+"and smn_control_acceso.smn_asistencia.asi_fecha_evento <= p.cpa_fecha_hasta_cal";
							...
							sentenciaValidarP="select smn_control_acceso.smn_personal.smn_personal_id, " 
		                		...
		                		" and smn_control_acceso.smn_personal.psl_estructura_organizacional_rf="+estructuraId+
		                		" and smn_control_acceso.smn_personal.psl_esquema_rotacion_rf="+esquemaId+
		                		" and smn_control_acceso.smn_asistencia.asi_fecha_evento >= smn_control_acceso.smn_plan_asistencia.cpa_fecha_desde_cal " +
		                		"and smn_control_acceso.smn_asistencia.asi_fecha_evento <= smn_control_acceso.smn_plan_asistencia.cpa_fecha_hasta_cal";
					
					}
				}
                
                System.out.println(sentenciaValidarP);
                Recordset rsval = this.getDb().get(sentenciaValidarP);
                System.out.println("*********** Cantidad en Validar = "+rsval.getRecordCount());
                if(rsval.getRecordCount()==0){
...
//		        			System.out.println(existenPermisos+" -- "+permisoL);
		        			...
		        			String sentenciasDia_N = this.GenerarSentencia(HorarioDia_N,diaEvento,idPlanAsistencia,rs.getString("psl_id_control_acceso"),rs.getString("smn_personal_id"),fechaEvento,diaEvento_2,permisoL,estructuraId,esquemaId, usuario);
			...
			System.out.println(timestamp+":ERROR: No se puede generar asistencia personal con asistencia en el periodo");
		}
	...
	public String GenerarSentencia(horarios dia, String nombreDia,String planAsistencia,String psl_id_control_acceso,String smn_personal_id,String fechEvento, String diaEvento,String asi_estatus_permiso_rf,int estructuraOrgId,int idEsqema, String usuario){
