...
//        Sera asi static File newTextFile = new File("./log.txt")?
      try {
          archivo = new FileWriter("logGenerarAsistencia.txt",false);
...
//           				objAsistencia.setFw(fw);
						...
						objAsistencia.generarAsitencia(rs.getString("smn_plan_asistencia_id"), rs.getInt("smn_esquema_rotacion_id"), rs.getInt("smn_estructura_organizacional_rf"), dias, rs.getString("cpa_fecha_desde_cal"), rs.getString("cpa_fecha_hasta_cal"), usuario);
