...
//    		logger.error("ERROR: "+e);
	...
	public ArrayList<String[]> listaTipoActividad(Connection con){
	    ArrayList<String[]> tipoActividades = new ArrayList<String[]>();
	    
	    try {
		
           	Statement sql=null;
      		ResultSet rs=null;
      		String sentencia ="SELECT * FROM smn_gip.smn_tipo_actividades";
      		sql=con.createStatement();
            rs=sql.executeQuery(sentencia);
            ...
            while(rs.next()){
            	...
            	String[] data = {
            			rs.getString("smn_tipo_actividades_id"),
            			rs.getString("tya_codigo"),
            			rs.getString("tya_nombre")
            	};
			...
			logger.info("******************ERROR******************");
			logger.info("Buscar en listaTipoActividad :"+e);
			logger.info("******************ERROR******************");
		}
