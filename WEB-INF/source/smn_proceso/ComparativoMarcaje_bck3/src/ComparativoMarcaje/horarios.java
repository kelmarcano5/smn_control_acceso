...
public class horarios {
	public final static Logger logger = Logger.getLogger(horarios.class);

	public int smn_horarios_id;
	public String hor_hora_inicio, hor_hora_final, hor_descanso_inicio, hor_descanso_final, hor_descripcion,dia_mas_uno;
	...
	public String getHor_descripcion() {
		return hor_descripcion;
	}

	public void setHor_descripcion(String hor_descripcion) {
		this.hor_descripcion = hor_descripcion;
	}
	
	

	public String getDia_mas_uno() {
		return dia_mas_uno;
	}

	public void setDia_mas_uno(String dia_mas_uno) {
		this.dia_mas_uno = dia_mas_uno;
	}
	...
	public ArrayList<horarios> listaHorarios(Connection con){
        ...
        try {
            ...
            while(rs.next()){
            	...
            	obj.setHor_descripcion(rs.getString("hor_descripcion"));
            	obj.setDia_mas_uno(rs.getString("hor_dia_mas_uno"));
            	dias.add(obj);
            }
...
//			System.out.println(el.getSmn_horarios_id());
